<script lang="ts">
    ...
    let emergencyAccessModalOpen = $state(false);
    ...
    async function copyUsernameToClipboard() {
      await invoke("copy_username", { secretId: secret.id });
    }
    ...
    <div class="flex items-center justify-between m-4">
      <div class="flex w-full">
        <div class="card bg-base-300 rounded-box h-20 flex flex-row grow items-center space-x-2 px-4 flex-1">
          ...
          <button aria-label="copy-username" class="pointer-events-auto p-2 bg-transparent border-none text-accent hover:text-primary-dark focus:outline-none focus:ring-2 focus:ring-success mr-2" onclick={copyUsernameToClipboard}>
            <input 
              type="text"
              id="username" 
              name="username"
  ...
  <div class="space-y-2">
    ...
    <div class="flex justify-between">
      <div class="flex justify-start">
        <button aria-label="share-secret" class="p-2 bg-transparent border-none text-accent hover:text-primary-dark focus:outline-none focus:ring-2 focus:ring-success mr-2" onclick={() => {emergencyAccessModalOpen = true}}>
...
<SecretDeleteForm 
  ...
  <EmergencyAccessGrant
    secretId={secret.id}
    secretTitle={secret.title}
    isOpened={emergencyAccessModalOpen}
    onClose={() => emergencyAccessModalOpen = false}
  />